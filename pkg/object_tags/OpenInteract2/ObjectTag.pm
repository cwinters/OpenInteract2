package OpenInteract2::ObjectTag;

# $Id: ObjectTag.pm,v 1.1 2005/03/29 05:10:37 lachoy Exp $
...
@OpenInteract2::ObjectTag::ISA = qw( OpenInteract2::ObjectTagPersist );
...
OpenInteract2::ObjectTag - SPOPS class for lightweight object tags
...
=head1 SYNOPSIS
 ...
 # Find all the OpenInteract2::ObjectTag objects tagged with
 # 'linux'
 ...
 # Display the OpenInteract2::ObjectTag objects
...
Returns: arrayref of distinct L<OpenInteract2::ObjectTag> objects
...
L<OpenInteract2::TaggableObject>: To call some of these methods in
relation to another object.

L<OpenInteract2::Observer::AddObjectTags>: Which adds tags based on
object adds/updates.
